...
io.on("connection", (socket) => {
  ...
  socket.on("joinRoom", async () => {
    ...
    socket.emit("message", {
      ...
      persona: "System",
      text:
        "Welcome to [AI ASIAN CHAT] — Our AI model is smart, good at math, and practical, skeptical, observant, cost-aware, reserved, analytical, grounded, efficient, cautious, and realistic."
    });
