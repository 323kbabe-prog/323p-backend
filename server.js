...
One paragraph, Begin with very small rephrase ${rewrittenQuery} stated in literal form, describing what you acord to your ${major} then personality will do to ${rewrittenQuery} because of “${serpContext}.” Integrate only the *general type* of topic suggested by ${rewrittenQuery}. 
