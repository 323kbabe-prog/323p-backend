...
One paragraph, beginning with a very short 2 sentences first sentence start with "I will" referring to ${rewrittenQuery} in literal form, describing what you personally noted to your ${major},  then personality will do to ${rewrittenQuery} because of “${serpContext}.” Integrate only the *general type* of topic suggested by ${rewrittenQuery}. 
