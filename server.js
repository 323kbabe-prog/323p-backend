// ////////////////////////////////////////////////////////////
//  server.js — NPC Browser (Super Agentic Trend Edition FINAL)
// ////////////////////////////////////////////////////////////
...
// ==========================================================
// TREND WORD SPLITTER — prevents glued words
// ==========================================================
...
// ==========================================================
// RANDOM DEMOGRAPHICS + ACADEMIC IDENTITY
// ==========================================================
...
// ==========================================================
// SOCKET.IO — PERSONA STREAMING (10 UNIQUE)
// ==========================================================
...
`;
        ...
        persona.hashtags = parsed.hashtags || ["trend","vibes"];

        // ---------------------------------------
        // 2. AGENTIC TREND ENGINE (AG4 + K2)
        //    4 keywords: vibe + emotion + aesthetic + culture
        // ---------------------------------------
        const trendPrompt = `
Transform the following into EXACTLY 4 SHORT TREND KEYWORDS (1–2 words each).
Style: Creative Hybrid (vibe + culture + emotion + aesthetic)
...
`;
        ...
        const trendParsed = safeJSON(tResp.choices?.[0]?.message?.content || "") 
        ...
        // ensure exactly 4
        trendWords = trendWords.slice(0,4);

        persona.trend = trendWords;
...
function writeViews(v){
  ...
  catch(e){ console.error("⚠️ Could not save views:", e.message); }
}
...
httpServer.listen(PORT,()=>{
  console.log(`🔥 NPC Browser (Agentic Trend v1.0) running on :${PORT}`);
});