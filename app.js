...
// 🧩 Split description text into ~40-word or ~60-character chunks depending on language
...
// English and other languages — split by 40 words
const words = text.split(/\s+/);
for (let i = 0; i < words.length; i += 40) {
segments.push(words.slice(i, i + 40).join(" "));
}
}
